...
static const char *fonts[]          = { "NotoSansCJK-VF:size=10" };
static const char dmenufont[]       = "NotoSansCJK-VF:size=10";
...
static const char *inclight[] = { "light", "-A", "1", NULL };
static const char *declight[] = { "light", "-U", "1", NULL };
...
/*modifier                        key        function        argument */
  ...
  { 0,             XF86XK_MonBrightnessDown, spawn,          {.v = devlight } },
  { MODKEY,                       XK_Up,     focusstack,     {.i = +1 } }, /* windows */
  { MODKEY,                       XK_Down    focusstack,     {.i = -1 } },
  { MODKEY,                       XK_i,      incnmaster,     {.i = +1 } },
  { MODKEY,                       XK_d,      incnmaster,     {.i = -1 } },
  { MODKEY,                       XK_Equals, setmfact,       {.f = -0.05} },
  ...
  TAGKEYS(                        XK_4,                      3)
  TAGKEYS(                        XK_5,                      4)
  { MODKEY,                       XK_comma,  focusmon,       {.i = -1 } }, /* monitors */
  { MODKEY,                       XK_period, focusmon,       {.i = +1 } },
  { MODKEY|ShiftMask,             XK_comma,  tagmon,         {.i = -1 } },
  { MODKEY|ShiftMask,             XK_period, tagmon,         {.i = +1 } },
  { MODKEY,                       XK_t,      setlayout,      {.v = &layouts[0]} }, /* layouts */
  { MODKEY,                       XK_f,      setlayout,      {.v = &layouts[1]} },
  { MODKEY,                       XK_m,      setlayout,      {.v = &layouts[2]} },
  { MODKEY,                       XK_p,      setlayout,      {0} },
  { MODKEY|ShiftMask,             XK_p,      togglefloating, {0} },
  { MODKEY,                       XK_b,      togglebar,      {0} }, /* special? */
