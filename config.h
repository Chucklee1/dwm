...
static const char *colors[][3]      = {
	/*               fg         bg         border   */
	[SchemeNorm] = { base06, base00, base02 },
	[SchemeSel]  = { base06, base0D, base0D },
};
...
static const char *dmenucmd[] = { "dmenu_run", "-m", dmenumon, "-fn", dmenufont, "-nb", base00, "-nf", base06, "-sb", base0D, "-sf", base06, NULL };
static const char *termcmd[]  = { "kitty", NULL };
static const char *editorcmd[]  = { "emacsclient", ".", NULL };
